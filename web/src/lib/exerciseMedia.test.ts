...
// In-memory stand-in for localStorage so fetchWithCache's cache reads/writes are exercised
// for real, without a browser (this test runs under vitest's node env, which has no
